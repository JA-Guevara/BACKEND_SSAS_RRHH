...
**[`ARQUITECTURA_BACKEND_FASTAPI.md`](../arquitectura/ARQUITECTURA_BACKEND_FASTAPI.md)**:
...
| Documento | Contenido |
|---|---|
| [Índice de documentación](../README.md) | Acceso ordenado a toda la documentación del backend |
| [Arquitectura del backend](../arquitectura/ARQUITECTURA_BACKEND_FASTAPI.md) | Diseño, principios y decisiones adoptadas |
| [Análisis y propuesta](../analisis/ANALISIS_Y_PROPUESTA_BACKEND.md) | Auditoría histórica y estructura propuesta |
| [Sprint 0 — adaptación ORM](../sprints/SPRINT_0_ADAPTACION_ORM.md) | Estado de modelos, migraciones y verificaciones |
