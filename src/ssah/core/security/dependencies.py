...
from ssah.auth.domain.exceptions import AuthError
from ssah.core.security.jwt import JWTService
from ssah.core.tenancy.context import require_empresa_context
from ssah.infrastructure.database.session import get_session
from ssah.roles.application.use_cases.check_permission import CheckPermission
from ssah.roles.domain.exceptions import PermissionDeniedError
from ssah.roles.infrastructure.persistence.repositories.authorization_repository import (
