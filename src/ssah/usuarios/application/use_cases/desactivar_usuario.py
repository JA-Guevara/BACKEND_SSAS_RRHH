from ssah.usuarios.domain.entities.usuario import Usuario
from ssah.usuarios.domain.exceptions import LastAdminCannotBeDisabledError, UsuarioNotFoundError
from ssah.usuarios.ports.outgoing.usuario_repository import UsuarioRepository
